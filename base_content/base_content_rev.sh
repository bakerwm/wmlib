...
# input <- args[1] # stat.txt
# outpng <- args[2] # out.png
...
# ##
# png1 <- gsub(".png$", "_bar.png", outpng)
# png2 <- gsub(".png$", "_line.png", outpng)
# ggsave(png1, p1, width = 5, height = 3, units = "in")
# ggsave(png2, p2, width = 5, height = 3, units = "in")
...
[[ ! -d $o ]] && echo "output directory not exists, exiting ..." && exit 1
